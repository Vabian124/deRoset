                ...
                <div class="form">
                    <form action="verwerk/item-bewerk.php?id=<?php echo $id ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="radio" id="is_flavor_of_week" name="is_flavor_of_week" value="1" <?php if ($idProducts['is_flavor_of_week'] == "1") {
                                                                                                                echo "checked=\"checked\"";
                                                                                                            } ?>>
                            <label for="is_flavor_of_week">Yes</label>
                            <input type="radio" id="is_flavor_of_week" name="is_flavor_of_week" value="0" <?php if ($idProducts['is_flavor_of_week'] == "0") {
                                                                                                                echo "checked=\"checked\"";
                                                                                                            } ?>>
